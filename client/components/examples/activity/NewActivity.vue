            ...
            <el-row type="flex" justify="flex-start">
                ...
                <el-col :xs="24" :sm="{ span: 10, offset: 2 }">
                    <el-form-item :label="$t('activity.area')" prop="region">
                        <el-select v-model="formData.region" filterable allow-create
                            :placeholder="$t('activity.holder.area')">
                            <el-option v-for="item in cities" v-show="!item.disabled" 
                                :key="item.label" :label="$t(item.label)" :value="item.value"/>
                        </el-select>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row type="flex" justify="flex-start">
                <el-col :xs="24" :sm="10">
                    <el-form-item :label="$t('activity.tag')" prop="label">
                        <el-select v-model="formData.label" multiple filterable allow-create
                            :placeholder="$t('activity.holder.tag')">
                            <el-option v-for="item in labels" :key="item.label" :label="$t(item.label)" 
                                :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :xs="24" :sm="{ span: 3, offset: 2 }">
                    <el-form-item :label="$t('activity.instDist')" prop="delivery">
                        <el-switch active-text="" inactive-text="" v-model="formData.delivery">
                        </el-switch>
                    </el-form-item>
                </el-col>
            </el-row>
