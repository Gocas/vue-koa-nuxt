            ...
            >
                <el-card>
                    <el-form
                        :model="user"
                        ref="user"
                        @keyup.enter.native="!logging && login()"
                    >
                        <el-form-item
                            prop="userName"
                            :rules="[
...
export default class Login extends Vue {
    ...
    getCaptcha () {
      ...
      this.captchaSvg = this.$axios
        .get('/hpi/auth/captcha', { params })
        .then(response => {
          // #WatchHowDoWe
